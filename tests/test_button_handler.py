...
class MockEvent(Event):
    def __init__(
        ...
        Event.__init__(self, key_number, pressed)
...
class MockEventQueue(EventQueue):
    def __init__(self, max_events):
        EventQueue.__init__(self, max_events)
    ...
    def __bool__(self) -> bool:
        return EventQueue.__bool__(self)

    def __len__(self) -> int:
        return EventQueue.__len__(self)
